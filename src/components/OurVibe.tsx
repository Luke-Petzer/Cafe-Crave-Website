  ...
  return <section id="our-vibe" className="section-animate section-light py-20 md:py-28">
      <div className="container mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-10 max-w-6xl mx-auto">
          {/* Perfectly Brewed */}
          <div className="bg-lightBg bg-opacity-95 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hh:-translate-y-2 hh:shadow-lg focus-within:ring-2 focus-within:ring-accent focus-within:ring-opacity-50 border border-lightText border-opacity-10" tabIndex={0}>
            <div className="h-48 overflow-hidden">
              <img src={coffeeImg} alt="Artisan latte art at Café Crave" className="w-full h-full object-cover transition-transform duration-300 hh:scale-105" loading="lazy" width="800" height="600" />
            </div>
            <div className="p-6">
          ...
          <div className="bg-lightBg bg-opacity-95 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hh:-translate-y-2 hh:shadow-lg focus-within:ring-2 focus-within:ring-accent focus-within:ring-opacity-50 border border-lightText border-opacity-10" tabIndex={0}>
            <div className="h-48 overflow-hidden">
              <img src={vinylImg} alt="Vinyl records spinning on a turntable at Café Crave" className="w-full h-full object-cover transition-transform duration-300 hh:scale-105" loading="lazy" width="800" height="600" />
            </div>
            <div className="p-6">
              <div className="flex items-center mb-4">
                <div className="bg-darkBg w-12 h-12 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
          ...
          <div className="bg-lightBg bg-opacity-95 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hh:-translate-y-2 hh:shadow-lg focus-within:ring-2 focus-within:ring-accent focus-within:ring-opacity-50 border border-lightText border-opacity-10" tabIndex={0}>
            <div className="h-48 overflow-hidden">
              <img src={boardGamesImg} alt="Friends playing board games at Café Crave in Claremont" className="w-full h-full object-cover transition-transform duration-300 hh:scale-105" loading="lazy" width="800" height="600" />
            </div>
            <div className="p-6">
              <div className="flex items-center mb-4">
                <div className="bg-darkBg w-12 h-12 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
