  ...
  return <section className="section-dark relative min-h-[600px] md:min-h-[650px] flex items-center animate-fade-in pt-20" aria-label="Hero section">
      ...
      <div id="main-content" className="relative z-10 container mx-auto px-6 md:px-10 lg:px-16">
        <div className="max-w-2xl">
          ...
          <Link to="/menu" className="bg-accent hover:bg-opacity-90 text-light px-8 py-4 rounded-md inline-flex items-center font-medium transition-colors text-lg focus:outline-none focus:ring-2 focus:ring-accent focus:ring-opacity-50">
            View Our Menu
