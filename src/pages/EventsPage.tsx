        ...
        <section className="relative min-h-[600px] md:min-h-[650px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-6 md:px-10 lg:px-16">
            <div className="max-w-4xl mx-auto text-center text-darkText">
              ...
              <a
                href="#upcoming"
                className="pressable bg-accent hover:bg-opacity-90 text-light px-8 py-4 rounded-md inline-flex items-center font-medium text-lg transition-[transform,box-shadow,background-color] duration-200 ease-out hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-accent focus:ring-opacity-50"
              >
              ...
              <div className="bg-light bg-opacity-10 rounded-lg p-12 md:p-16">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="pressable bg-accent hover:bg-opacity-90 text-light px-6 py-3 rounded-md inline-flex items-center justify-center font-medium transition-[transform,box-shadow,background-color] duration-200 ease-out hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-accent focus:ring-opacity-50"
                  >
                    Follow for Updates
